...
p0wnedShell is a PowerShell host application build in C# that does not rely on powershell.exe and has a lot of offensive PowerShell modules and binaries included to make the process of Post Exploitation easy-er.
